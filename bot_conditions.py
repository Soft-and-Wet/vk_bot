class BotConditions:
    ...
    def conditions(self, bot_functions, main_keyboard, reminder_create_keyboard,
        ...
        elif self.event.obj.message['text'] == "Создать напоминание":
            bot_functions.reminder_create_on(reminder_create_keyboard, main_keyboard)
        elif self.event.obj.message['text'] == "Показать напоминание":
            bot_functions.reminder_print(main_keyboard)
        elif self.event.obj.message['text'] == "Удалить напоминание":
            bot_functions.reminder_delete(main_keyboard)
        elif self.event.obj.message['text'] == "Играть в города":
            bot_functions.cities_start(cities_start_keyboard)
        elif self.event.obj.message['text'] == "Завершить игру в города":
